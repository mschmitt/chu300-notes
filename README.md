...
Note you can always use an external monitor to work around and on the display's limitations.
...
The xe driver seems to be in an eternal conflict with the i915 driver if loading of i915 is delayed as follows. **If your device shows weird artifacts after booting, suspend and resume.** This hack in */etc/modprobe.d/i915.conf* seems to fix the artifacts:
